...
describe("Code works", () => {
  ...
  it("workingWithIntArrays works", () => {
    assert.deepEqual(code.workingWithIntArrays(), [1, 2, 34, 55, 666, 123412415]);
  });
  it("workingWithMixedArrays works", () => {
    assert.deepEqual(code.workingWithMixedArrays(),  [1, 2, "cabbages", 34, 55, 666, 123412415]);
  });
  it("workingWithObjects works", () => {
    assert.deepEqual(code.workingWithObjects(), { greeting: "Hello", age: 20, city: "Liverpool" });
  });
});
